...
Understand the dataset and identify potential diabetes risk factors.

---

## Questions

* What is the diabetes prevalence in the dataset?
* Which variables differ most between diabetic vs non-diabetic patients?
* Are there strong health indicator patterns?
...
* At least 20 meaningful charts, including:
  ...
  * diabetes vs feature comparisons
...
* Written insights:
  ...
  * summary of main diabetes risk factors
...
* Optional:
  ...
  * initial hypotheses about diabetes risk
...
* Use chart types intelligently:
  ...
  * for continuous numerical variables (age, bmi, HbA1c_level, blood_glucose_level), prefer density-style plots such as KDE when the distribution is meaningful to inspect smoothly
  * for discrete numerical variables (hypertension, heart_disease), prefer histograms or count-based plots
  * for categorical variables (gender, smoking_history), prefer proportion charts or count plots that make category comparisons easy to read
...
* Explicitly document candidate feature engineering decisions, such as:
  ...
  * handling of "No Info" categories in smoking_history
  * encoding considerations
  * ordinal mappings for smoking_history
  * nominal dummy encoding with `N-1` dummies
  * outlier treatment ideas for BMI
