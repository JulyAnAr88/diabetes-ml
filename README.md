...
This project is designed as a hands-on bootcamp to learn how to use AI to accelerate a full data workflow:

* Exploratory Data Analysis (EDA)
* Machine Learning modeling (diabetes prediction)
* Simple production simulation (Streamlit app)
* Business reporting (BI-ready outputs)

The focus is not only on building a diabetes prediction model, but on **how to work effectively with AI in a structured, reproducible way**.

---

## Dataset

We use the **Diabetes Prediction Dataset**.

Goal:
Predict whether a patient has diabetes based on health indicators and identify key risk factors.
...
Expected local file:
* Download the dataset and store the CSV as `data/raw/diabetes-prediction-dataset.csv`
* If Kaggle provides a different filename, rename it to `diabetes-prediction-dataset.csv` or update your data-loading code explicitly

---

## How to Work in This Project

Before starting, read `docs/00_project_overview.md`.
...
4. Download the dataset from Kaggle and place it in:
   * `data/raw/diabetes-prediction-dataset.csv`
...
* A clear EDA with health insights
* A working diabetes prediction model
