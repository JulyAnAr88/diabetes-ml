...
If `data/raw/diabetes-prediction-dataset.csv` does not exist yet, download it from:
- `https://www.kaggle.com/datasets/iammustafatz/diabetes-prediction-dataset`

Then store the CSV as `data/raw/diabetes-prediction-dataset.csv`.
If the downloaded file has a different name, rename it to `diabetes-prediction-dataset.csv` before continuing.
